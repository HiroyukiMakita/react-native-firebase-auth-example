...
import { ApplicationVerifier, createUserWithEmailAndPassword, PhoneAuthProvider, signInWithCredential } from 'firebase/auth';
...
const RegisterUsePhoneNumberScreen = () => {
    ...
    const recaptchaVerifier = React.useRef(null as unknown as ApplicationVerifier);
